...
// High-quality travel destination images with better gradients
const placeholders = {
  'cancun.jpg': {
    title: 'Cancun Beach',
    svg: `
      <svg width="800" height="600" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="400" y="250" font-size="60" text-anchor="middle" fill="white" font-weight="bold">🏖️ Cancun</text>
        <text x="400" y="320" font-size="32" text-anchor="middle" fill="white" opacity="0.9">Paradise Beach</text>
      </svg>
    `
  },
  'barbados.jpg': {
    ...
    svg: `
      <svg width="800" height="600" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="400" y="250" font-size="60" text-anchor="middle" fill="white" font-weight="bold">🌴 Barbados</text>
        <text x="400" y="370" font-size="32" text-anchor="middle" fill="white">Tropical Paradise</text>
      </svg>
    `
  },
  'tahiti.jpg': {
    ...
    svg: `
      <svg width="800" height="600" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="400" y="280" font-size="60" text-anchor="middle" fill="white" font-weight="bold">🌺 Tahiti</text>
        <text x="400" y="350" font-size="32" text-anchor="middle" fill="white">Island Paradise</text>
      </svg>
    `
  },
  'riviera.jpg': {
    ...
    svg: `
      <svg width="800" height="600" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="400" y="280" font-size="60" text-anchor="middle" fill="white" font-weight="bold">⛱️ Riviera Maya</text>
        <text x="400" y="350" font-size="32" text-anchor="middle" fill="white">Cenote Paradise</text>
      </svg>
    `
  },
  'panama.jpg': {
    ...
    svg: `
      <svg width="800" height="600" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="400" y="150" font-size="60" text-anchor="middle" fill="white" font-weight="bold">🌊 Panama</text>
        <text x="400" y="220" font-size="32" text-anchor="middle" fill="white">Canal Paradise</text>
      </svg>
    `
  }
};
...
Object.entries(placeholders).forEach(([filename, data]) => {
  fs.writeFileSync(path.join(imagesDir, filename), data.svg);
